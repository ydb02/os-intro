...
![Справка команды архивации](image/01.png){ #fig:001 width=70% }

![Создание файла и дача ему прав](image/02.png){ #fig:002 width=70% }

![Скрипт](image/03.png){ #fig:003 width=70% }

![Скрипт в домашней папке](image/04.png){ #fig:004 width=70% }
...
![Скрипт 2](image/05.png){ #fig:005 width=70% } 

![Вывод всех переданных аргументов](image/06.png){ #fig:006 width=70% } 
...
![Командный файл](image/07.png){ #fig:007 width=70% } 
...
![Скрипт 3](image/09.png){ #fig:009 width=70% }

![Вычисление количества файлов](image/10.png){ #fig:010 width=70% }

# Библиография

https://infopedia.su/24x10498.html

https://esystem.rudn.ru/pluginfile.php/1142517/mod_resource/content/2/008-lab_shell_prog_1.pdf
...
В пере1. Командный процессор (командная оболочка, интерпретатор команд shell) —
...
– ${#name[*]} и ${#name[@]} — эти выражения возвращают количество элементов в массиве name.менные mon и day будут считаны соответствующие значения, введённые с клавиатуры, а переменная trash нужна для того, чтобы отобрать всю избыточно введённую информацию и игнорировать её.
